...
-- WARN: How to open the terminal in first place
...
-- Keybinds to move lines up/down using Alt
vim.keymap.set('n', '<M-j>', ':m .+1<CR>==', { silent = true, desc = 'Move line down by 1' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      --
      -- Two important keymaps to use while in telescope are: -- WARN: explicitly mention to use follwing inside :Telescope help_tags. or maybe I am just stupid?
      --  - Insert mode: <c-/>
      --  - Normal mode: ?
      --
      ...
      vim.keymap.set('n', '<leader><leader>', builtin.buffers, { desc = '[ ] Find existing buffers' }) -- WARN: put telescope in normal mode rather that in insert mode?
